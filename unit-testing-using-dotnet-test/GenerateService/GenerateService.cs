...
{
    public class Generator //zmienione na public
    {
        //[Wycięta metoda Account]       
        public string GenerateNewID(string bin, int length) //zmienione na public
        {
        ...
        public string GenerateNewPin() //zmienione na public
        {
            Random random = new Random();
        ...
        public int GenerateCheckDigit(int[] digits) //zmienione na public
        {
        ...
        public int CalculateSum(int[] digits, int bitShift = 0) //zmienione na public
        {
